...
<div class="wrapper">
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" id="notyf">
        <?php 
    ...
    <li class="nav-item dropdown">
        ...
        <?php 
          ...
          while($row = mysqli_fetch_array($query)){ 
              ...
              echo "<div class='dropdown-divider'></div>
              <a href='./pages/readMail.php?id=$id' class='dropdown-item'>    
              <div class='media'>
    ...
    <li class="nav-item">
      <h4 style="color:green"><a href="#">B Shop</a></h4>
    </li>
  </ul>
  </nav>
  <!-- /.navbar -->
                    ...
                    <form method="POST" action="../../action.php" class="form-horizontal">
                      ...
                      <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                          <button type="submit" name="reset_pwd_bshop" class="btn btn-danger">Submit</button>
                        </div>
                      </div>
                    </form>
                  </div>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-between">
          ...
          <button type="submit" name="changePhoneBshop" class="btn btn-primary">Save changes</button>
          </form>
        </div>
      </div>
      <!-- /.modal-content -->
  ...
  <div class="modal fade" id="modal-sm-name">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-between">
          <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
          <button type="submit" name="changeNameBshop" class="btn btn-primary">Save changes</button>
          </form>
        </div>
      </div>
      <!-- /.modal-content -->
...
//   loadNotifications(){
  ...
  //   $.ajax({
  //     type: 'post',
  //     url: '../../pages/getNotifications.php',
  //     data: {
  //     user_id:user,
  //     },
  //     success: function (response) { 
  ...
  // }
  // loadNotificationscount(){
  //   alert('Load notifications count');
  //   var user = 1;
  //   $.ajax({
  //     type: 'post',
  //     url: '../../pages/getNotificationsCount.php', 
