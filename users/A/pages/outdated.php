...
$sql = "SELECT * FROM users WHERE status = 'Deactive' ORDER BY id DESC";
...
<head>
  ...
  <title>WAPORADIO | Dissabled Users</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Dissabled Users</li>
            </ol>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
                  ...
                  <?php 
                    ...
                    if ($results->num_rows > 0) {
                      while($row = $results->fetch_assoc()) {
                        ...
                        echo "<tr><td>" . $NO. "</td><td>". $row["userName"]."</td><td>". $row["phone"]."</td><td>".$role."</td><td><a>".$row["status"]."</a></td>";
                        $NO++;
                      }
                    } else {
