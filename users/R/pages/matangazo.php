                  ...
                  function add_or_update_params($url,$key,$value){
                    ...
                    if ($results->num_rows > 0) {
                      while($row = $results->fetch_assoc()) {
                        ...
                        echo "<tr><td>" . $NO. "</td><td>". $row["tangazoName"]."</td><td>". $ownerNamee."</td><td>". $issuedate."</td><td $class>".$display."</td><td>". $row["statuss"]."</td><td><a $link>$more</a></td>";
                        $NO++;
                      }
                    } else {
                      echo "<tr><td><h6 style='color:red'>You didn't register any Tangazo yet; To register click 'New Tangazo' on top bar menu</h6></td></tr>";
                    }
                    $conn->close();
                  ?>
                  </tr>
