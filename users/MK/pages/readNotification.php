...
<head>
  ...
  <title>WAPORADIO | Notification Read</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item dropdown">
      ...
      <li class="nav-item">
        <h4 style="color:green"><a href="../profile.php">Director</a></h4>
      </li>
    </ul>
  </nav> 
  <!-- /.navbar -->
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
            <a href="./notifications.php" class="btn btn-primary btn-block mb-3">Back to Notifications</a>
          ...
          <?php 
            $mid = $_REQUEST['id'];
            $qrry = "SELECT lineup.adpTime,adnotifications.responce,adnotifications.status,adnotifications.feedback,matangazo.tangazoName,vipindi.kipindiname FROM adnotifications,lineup,matangazo,vipindi WHERE adnotifications.lineupFk = lineup.id AND lineup.adFk = matangazo.id AND lineup.kipindFk = vipindi.id AND adnotifications.id = $mid";
            $Msg = $conn->query($qrry);
            $sql = "UPDATE adnotifications SET status = 'read' WHERE id = '$mid'";
            if ($conn->query($sql) === TRUE) {}
            if($Msg->num_rows > 0){
              while($Umsg = $Msg->fetch_assoc()){
                $msgSubject = $Umsg["tangazoName"];
                $messgContent = $Umsg["kipindiname"];
                $msgtime = $Umsg["adpTime"];
                $feedback = $Umsg["feedback"];
                $responce = $Umsg["responce"];
              }
            }
          ?>
        <div class="col-md-9">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                ...
                <h6>Play Time :
                  <?php 
                  $Weddingdate = new DateTime($msgtime);
                  $mstime = $Weddingdate->format('d-m-Y H:i:s');
                  echo $mstime; ?></h6>
              </div>
              <!-- 15 Feb. 2015 11:03 PM -->
              <div class="mailbox-read-message">
                <p id="messageContent">Programme : <?php echo $messgContent ?></p>
              </div>
