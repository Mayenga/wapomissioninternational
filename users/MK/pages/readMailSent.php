...
<div class="wrapper">
  ...
  <li class="nav-item dropdown">
    ...
    <li class="nav-item dropdown">
      ...
      <li class="nav-item">
        <h4 style="color:green"><a href="../mkurugenzi.php">Director</a></h4>
      </li>
    </ul>
  </nav> 
  <!-- /.navbar -->
    ...
    <!-- /.content-header -->
      ...
      <div class="container-fluid">
        <div class="row">
                ...
                <ul class="nav nav-pills flex-column">
                  <li class="nav-item active">
                    <a href="./mailbox.php" class="nav-link">
                      ...
                      $qrry = "SELECT * FROM messages WHERE status = 'not read' AND userFk = 1";
          ...
          <?php 
            $mid = $_REQUEST['id'];
            $qrry = "SELECT * FROM messages WHERE id = $mid";
            $Msg = $conn->query($qrry);
            $sql = "UPDATE messages SET status = 'read' WHERE id = '$mid'";
            if ($conn->query($sql) === TRUE) {}
            if($Msg->num_rows > 0){
              while($Umsg = $Msg->fetch_assoc()){
                $msgSubject = $Umsg["subject"];
                $messgContent = $Umsg["message"];
                $msgtime = $Umsg["time"];
              }
            }
          ?>
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              ...
              <div class="mailbox-read-message">
                <p id="messageContent"><?php echo $messgContent ?></p>
              </div>
