        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./matangazo.php" class="nav-link active">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form>
          <?php 
            $leo = date("Y-m-d");
            $sevnDays = date('Y-m-d', strtotime("-7 days"));
            $month = date('Y-m-d', strtotime("-30 days"));
            $sixmonth = date('Y-m-d', strtotime("-180 days"));
          ?>
          <select name="users" onchange="showUser(this.value)">
          <option value="">Select dates:</option>
           <?php echo '<option value="'.$leo.'">Today</option>';?>
           <?php echo '<option value="'.$sevnDays.'">This Week</option>';?>
           <?php echo '<option value="'.$month.'">This Month</option>';?>
           <?php echo '<option value="'.$sixmonth.'">Last Six Months</option>';?>
          </select>
        </form>
          <div class="card">
            <div id="data"><table id="table_id" class="display table table-hover text-nowrap"><tr><td>Ads will be shown here</td></tr></table></div>
          </div>
          <!-- /.card --> 
      </div><!-- /.container-fluid -->
    </section>
