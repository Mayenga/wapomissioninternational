...
$sql = "SELECT * FROM matangazo WHERE statuss = 'Pending' ORDER BY id DESC";
...
<head>
  ...
  <title>WAPORADIO | Pending Ads</title>
                ...
                <tbody>
                  ...
                  function add_or_update_params($url,$key,$value){
                    ...
                    if ($results->num_rows > 0) {
                      ...
                      echo '<tr><td><h6 style="color:red">No Pending Ads at the moment...</h6></td></tr>';
                    }
                    $conn->close();
                  ?>
                  </tr>
