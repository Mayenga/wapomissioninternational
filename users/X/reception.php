...
//count all Programmes
$sql1 = "SELECT * FROM vipindi";

$total_programmes = mysqli_query($conn,$sql1);
$total_programmes = mysqli_num_rows($total_programmes);
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="./pages/active.php" style="color:white">
                <h3><?php echo $total_programmes; ?></h3>
                <p>Programmes</p>
              </a>
              </div>
              <div class="icon">
