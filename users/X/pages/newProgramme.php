...
<head>
  ...
  <title>WAPORADIO | newProgramme</title>
            ...
            <div class="card card-primary"> 
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label>Proggramme Name</label>
                  <input type="text" name="pname" class="form-control" placeholder="Enter programme..." required id="programmeName">
                </div>
                <div class="form-group">
                  <label>Proggramme Type</label>
                  <select name="ptype" class="form-control select2" style="width: 100%;" id="cnameOption">
                    <option value="LIVE" selected="selected">LIVE PROGRAME</option>
                    <option value="REC">RECODED PROGRAMME</option>
                  </select>
                </div>
                <div class="form-group">
                  <label>Odered By</label>
                  <input type="text" value="WRFM" name="oder" class="form-control" placeholder="Enter programme..." required id="programmeName">
                </div>
                <!-- Date range -->
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <!-- <input type="tim" name="etime" class="form-control float-right" id="reservation" required> -->
                  </div>
                <!-- Date range -->
                <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="saveProggramme" class="btn btn-primary" id="post">Submit</button>
                </div>
              </form>
              </div>
              <!-- /.card-body -->
