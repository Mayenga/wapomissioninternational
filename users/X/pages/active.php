...
$sql = "SELECT * FROM vipindi ORDER BY fromTime ASC";
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="./newProgramme.php" class="nav-link">Add Programm</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../pages/active.php" class="nav-link active">
              ...
              <table id="table_id" class="display table table-hover text-nowrap">
                ...
                <?php
                  if ($results->num_rows > 0) {
                    ...
                    <th>Start Time</th>
                    <th>End Time</th>
                    <th style="color:blue">Add Ads</th>
                    <th></th>
                    <th></th>
                    </tr>';
                  }
                ...
                <tbody>
                  <?php 
                    ...
                    $url1 = '../../../action.php?moreAdd=0';
                    $url2 = '../../../action.php?moreAddEdit=0';
                    $url3 = '../../../action.php?moreProgrammeEdit=0';
                    $more = "Add";
                    $more2 = "Edit Selection";
                    $more3 = "Edit Programme";
                    $NO = 1;
                    if ($results->num_rows > 0) {
                      while($row = $results->fetch_assoc()) {
                        $forLink = $row["id"];
                        $from = $row["fromTime"];//date_format(,"H:i");
                        $to = $row["toTime"];//date_format(,"H:i");
                        $url = add_or_update_params($url1,'more',$forLink);
                        $urll = add_or_update_params($url2,'more',$forLink);
                        $urlll = add_or_update_params($url3,'more',$forLink);
                        $link = 'href="'.$url.'"';
                        $link2 = 'href="'.$urll.'"';
                        $link3 = 'href="'.$urlll.'"';
                        echo "<tr><td>" . $NO. "</td><td>". $row["kipindiname"]."</td><td>". $from."</td><td>". $to."</td><td><a $link>$more</a></td><td><a $link2>$more2</a></td><td><a $link3>$more3</a></td>";
                        $NO++;
                      }
                    } else {
                      echo "<tr><td>No Programme Registered yet. Click on 'Add Programme' to register new Programme</td></tr>";
                    }
                    $conn->close();
                  ?>
                  </tr>
