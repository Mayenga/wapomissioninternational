<?php
    ...
    $sql2 = "SELECT vipindi.kipindiname,adnotifications.day,adnotifications.responce,matangazo.cost FROM matangazo,lineup,vipindi,adnotifications WHERE lineup.adFk = matangazo.id AND lineup.kipindFk = vipindi.id AND adnotifications.lineupFK = lineup.id";
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../users/B/bshop.php" class="nav-link">Home</a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="../users/B/bshop.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="../users/B/profile.php" class="d-block"><?php echo $_SESSION['USER_NAME']; ?></a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="../users/B/bshop.php" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../users/B/pages/matangazo.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ads</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../users/B/pages/active.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Active Ads</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../users/B/pages/pending.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pending Ads</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../users/B/pages/outdated.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Outated Ads</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../users/B/bshop.php">Home</a></li>
                    ...
                    <tbody>';                    
                      if ($results2->num_rows > 0) {
                        while($row = mysqli_fetch_array($results2)){
                          $Weddingdate = new DateTime($row["day"]);
                          $day = $Weddingdate->format('d-m-Y H:i');
                          $event = $row["responce"];
