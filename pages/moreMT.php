...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../users/MT/mwndaamatangazo.php" class="nav-link">Home</a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="../users/MT/mwndaamatangazo.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
        <a href="../users/MT/profile.php" class="d-block"><?php echo $_SESSION['USER_NAME']; ?></a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="../users/MT/mwndaamatangazo.php" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../users/MT/pages/active.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Active Ads</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../users/MT/pages/lineup.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Lineup</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../users/MT/mwndaamatangazo.php">Home</a></li>
                                  ...
                                  <div class="table-responsive">
                                      <table class="table">
                                          <tr>
                                              ...
                                              <td>'.$ownerNamee.'</td>
                                              <td>'.'<button type="button" class="btn btn-block btn-secondary btn-sm">Send Mail</button>'.'</td>
                                          </tr>
                                          <tr>
